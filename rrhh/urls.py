...
urlpatterns = [
    ...
    path('adelanto/<int:id>/aprobar-pm/',
         views.aprobar_adelanto_pm, name='aprobar_adelanto_pm'),
    path('adelanto/<int:id>/rechazar-pm/',
         views.rechazar_adelanto_pm, name='rechazar_adelanto_pm'),
    path('adelanto/<int:id>/aprobar-rrhh/',
         views.aprobar_adelanto_rrhh, name='aprobar_adelanto_rrhh'),
    path('adelanto/<int:id>/editar/',
         views.editar_adelanto_admin, name='editar_adelanto'),
    path('adelanto/<int:id>/eliminar/',
         views.eliminar_adelanto_admin, name='eliminar_adelanto'),
    path('adelantos/', views.listar_adelanto_admin, name='listar_adelanto_admin'),
    path('adelantos/usuario/', views.listar_adelantos_usuario,
         name='listar_adelantos_usuario'),
    path('adelanto/<int:pk>/eliminar-usuario/',
         views.eliminar_adelanto_usuario, name='eliminar_adelanto_usuario'),
    path('adelanto/<int:pk>/editar-usuario/',
         views.editar_adelanto_usuario, name='editar_adelanto_usuario'),
    # path('adelanto/', views.solicitar_adelanto_view, name='solicitar_adelanto'),
    path('adelantos/rechazar/rrhh/<int:solicitud_id>/',
