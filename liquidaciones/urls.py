...
from . import views
from .views import UsuarioAutocomplete, verificar_storage
...
urlpatterns = [
    ...
    path('confirmar-firma/<int:pk>/', views.confirmar_firma, name='confirmar_firma'),
    path('confirmar-reemplazo/', views.confirmar_reemplazo, name='confirmar_reemplazo'),
    ...
    path('ver-firmado/<int:pk>/', views.ver_pdf_firmado_admin, name='ver_pdf_firmado_admin'),
    ...
    path(
        'carga-masiva/preview-pdf/<int:index>/',
        views.preview_pdf_carga_masiva,
        name='preview_pdf_carga_masiva'
    ),
]